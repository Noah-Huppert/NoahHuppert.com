...
(function(){
  ...
  $(document).ready(function(){
    ...
    model.addTab(new Tab("projects"));
    model.getTabById("projects").loadContentFromUrl("https://raw.githubusercontent.com/Noah-Huppert/NoahHuppert.com/data/projects.json");
